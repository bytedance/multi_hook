...
int syn_recv_sock_test_init(void)
{
	...
	if  (hook_ctx_register_func(syn_recv_sock_v4_hook_ctx, HOOK_CTX_FUNC_PREV_TYPE, 1,
			(unsigned long)tcp_v4_syn_recv_sock_hook_func, 0) < 0)
		return -1;

	if  (hook_ctx_register_func(syn_recv_sock_v4_hook_ctx, HOOK_CTX_FUNC_POST_TYPE, 1,
...
{
	hook_ctx_unregister_func(syn_recv_sock_v4_hook_ctx, HOOK_CTX_FUNC_PREV_TYPE, 1);
	hook_ctx_unregister_func(syn_recv_sock_v4_hook_ctx, HOOK_CTX_FUNC_POST_TYPE, 1);
